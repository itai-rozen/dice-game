...
### If both dice have the same number - player loses all his points gained in current turn & turn is moved to the oponent.
### Winner is the player who gets to 100 first.

Bonus - players can change target score, name & avatar in the settings menu. You can choose any character from the awesome Mortal Kombat II. In other words - choose your destiny.
